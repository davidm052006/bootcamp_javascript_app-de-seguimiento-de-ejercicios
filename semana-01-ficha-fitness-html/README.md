# Ficha de Fitness & Ejercicios - David Mateo Paredes Ramírez

## 📋 Información

- **Nombre**: David Mateo Paredes Ramírez
- **Fecha**: 15/02/2026
...
1. Navega a la carpeta `semana-01-ficha-fitness-html/`
...
```bash
cd semana-01-ficha-fitness-html
